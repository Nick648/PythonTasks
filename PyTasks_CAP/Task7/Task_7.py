...
def main(x):  # x similar everywhere
    ...
    # print("b:", b, hex(b), bin(b), len(bin(b)) - 2, ",x >> 13:", x >> 13, bin(x >> 13), len(bin(x >> 13)) - 2)
    c = (x >> 28) & 0b1
    # print("c:", c, hex(c), bin(c), len(bin(c)) - 2, ",x >> 28:", x >> 28, bin(x >> 28), len(bin(x >> 28)) - 2)
    d = (x >> 29) & 0b111
    # print("d:", d, hex(d), bin(d), len(bin(d)) - 2, ",x >> 29:", x >> 29, bin(x >> 29), len(bin(x >> 29)) - 2)
