...
def parse_a(data, offset):
    ...
    a5 = parse_array_struct_c(data, 8, offset + 16)  # 96 = size array of struct C
...
for i in dic_1:
    if i == 'A3':
        print('A3:')
        for ib in dic_1[i]:
            print(" " * 4, str(ib) + str(":"), dic_1[i][ib])
    elif i == 'A5':
        print('A5:')
        for ic in range(len(dic_1[i])):
            for ics in dic_1[i][ic]:
                print(" " * 4, str(ics) + str(":"), dic_1[i][ic][ics])
    elif i == 'A6':
        print('A6:')
        for idi in dic_1[i]:
            print(" " * 4, str(idi) + str(":"), dic_1[i][idi])
    else:
        print(str(i) + str(":"), dic_1[i])
...
for i in dic_2:
    if i == 'A3':
        print('A3:')
        for ib in dic_2[i]:
            print(" " * 4, str(ib) + str(":"), dic_2[i][ib])
    elif i == 'A5':
        print('A5:')
        for ic in range(len(dic_2[i])):
            for ics in dic_2[i][ic]:
                print(" " * 4, str(ics) + str(":"), dic_2[i][ic][ics])
    elif i == 'A6':
        print('A6:')
        for idi in dic_2[i]:
            print(" " * 4, str(idi) + str(":"), dic_2[i][idi])
    else:
        print(str(i) + str(":"), dic_2[i])
